...
#==========================================================================#
# This script is for automating the generation of a Q20-cutoff of aligned 
...
# Define location of reference sequences (change as needed)
